...
class quick_start {
  ...
  private:
    ...
    void create_main_file() {
        ::fast_io::print(::fast_io::obuf_file("src/main.cpp"), R"(int main() {
...
{}
            ...
            option.cxx_standard,
            option.fast_io_required
                ? "    ${CMAKE_SOURCE_DIR}/fast_io/include\n)"
                : ")");
    ...
    void create_fast_io() {
        ::std::system("git submodule add -b next "
